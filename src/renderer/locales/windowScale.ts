export const windowScaleMessages = {
  en: {
    ...
    desktopDescription:
      'At the minimum window size, desktop lyrics use the baseline values. The mini layout lets the cover controls and lyrics use separate baselines.',
    compactDesktop: 'Mini Desktop Lyrics',
    normalDesktop: 'Normal Desktop Lyrics',
    minWidth: 'Minimum Width',
    minHeight: 'Minimum Height',
    baseFontSize: 'Lyrics Baseline Font Size',
  ...
  zh: {
    ...
    desktopDescription:
      '窗口达到设定的最小尺寸时使用对应基准；迷你桌面歌词的封面控件与右侧歌词可分别调整。',
  ...
  zht: {
    ...
    desktopDescription:
      '視窗達到設定的最小尺寸時使用對應基準；迷你桌面歌詞的封面控制與右側歌詞可分別調整。',

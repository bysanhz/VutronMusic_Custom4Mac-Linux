...
test.describe('library hydration and stable rendering', () => {
  test('repairs nullable persisted liked state and keeps the compact liked-song preview bounded', () => {
    ...
    expect(library).toContain('min-height: 64px;')
    expect(library).toContain('white-space: normal;')
    expect(library).toContain('overflow-wrap: anywhere;')
    expect(library).not.toContain('-webkit-line-clamp: 2;')

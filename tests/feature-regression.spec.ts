...
test.describe('library hydration and stable rendering', () => {
  test('repairs nullable persisted liked state and keeps the compact liked-song preview bounded', () => {
    ...
    expect(dataStore).toContain('.slice(0, 24)')
    expect(dataStore).toContain('detailResult.songs.slice(0, 8)')
    ...
    expect(library).toContain('grid-auto-rows: 94px;')
    expect(library).toContain('height: 94px;')
